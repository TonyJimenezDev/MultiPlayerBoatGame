...
public class CameraAction : MonoBehaviourPun
{
    Transform rootNode;
    Transform carCam;
    Transform car;
    ...
    void Awake()
    {
        ...
        transform.SetParent(GameObject.Find("PlayerBoat").transform);
    }
    ...
    void FixedUpdate()
    {
            ...
            if (carPhysics.velocity.magnitude < rotationThreshold) look = Quaternion.LookRotation(car.forward);
            else look = Quaternion.LookRotation(carPhysics.velocity.normalized);
